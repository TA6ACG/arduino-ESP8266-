...
const char* ssid = "XXXXXXXX"; // Input your wifi network name
...
void setup() {
  ...
  WiFi.begin(ssid, password);
   WiFi.softAP("csRelay", "passworSifre"); // remote control AP
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            // Web Page Heading
            client.println("<body><h1>4 Kanal Role</h1>");
            ...
            client.println("<p> Pinler=> (GPIO5 D1) -- (GPIO4 D2) -- (GPIO0 D3) -- (GPIO2 D4) </p>"); //connections pins 
